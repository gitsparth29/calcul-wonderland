...
const FinanceCategory = () => {
  return (
    <>
      <SEOHead
        title="Finance Calculators - Mortgage, Loan & Investment Tools"
        description="Free financial calculators for mortgages, loans, investments, retirement planning, and more. Calculate payments, interest rates, and plan your financial future."
        ...
        <main className="flex-1 bg-gradient-hero">
          <div className="container py-12">
            <header className="text-center mb-12 animate-fade-in">
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-primary mb-4 shadow-medium" aria-hidden="true">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto" aria-label="Finance calculators list">
