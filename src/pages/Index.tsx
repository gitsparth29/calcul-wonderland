  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section id="popular" className="py-16 md:py-20 bg-muted/30">
          <div className="container">
        ...
        <section className="py-16 md:py-20">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center bg-gradient-primary rounded-3xl p-8 md:p-12 shadow-large">
